...
#define SENSOD_RPDO_POSITION_ADVANCED  ((uint16_t) 0x277A)
#define SENSOD_RPDO_VELOCITY_ADVANCED  ((uint16_t) 0x27FF)
#define SENSOD_RPDO_EFFORT_ADVANCED  ((uint16_t) 0x2771)
...
enum ModeOfOperation
{
  ...
  MODE_CYCLIC_SYNC_POSITION_ADVANCED = -108
};
